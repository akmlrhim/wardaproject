      ...
      <div className="relative max-w-3xl mx-auto text-center text-white">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 md:p-8 shadow-xl transform transition-all hover:scale-[1.01]">
          ...
          <button
            ...
            className="redirect-to-wa group bg-white text-emerald-800 px-6 py-3 rounded-xl font-bold text-base hover:bg-emerald-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 inline-flex items-center gap-2"
          >
