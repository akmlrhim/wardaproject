      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="border-2 border-blue-200 rounded-2xl overflow-hidden">
          <div className="bg-blue-600 px-10 py-5 flex items-center justify-between">
            <p className="text-white font-bold uppercase tracking-widest text-sm">Penawaran Spesial</p>
            <span className="bg-yellow-400 text-yellow-900 text-xs font-bold px-4 py-1.5 rounded-full uppercase">
              Special Bonus
            </span>
          </div>
            ...
            <div>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex gap-5 items-start">
                  ...
                  <div>
                    <p className="text-lg font-bold text-slate-900">Investasi mulai Rp 25 Juta</p>
                ...
                <div className="flex gap-5 items-start">
                  ...
                  <div>
                    <p className="text-lg font-bold text-green-700">Special Mentoring</p>
              ...
              <button
                ...
                className="cursor-pointer bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-xl font-bold text-lg shadow-lg inline-flex items-center gap-3 transition-all hover:-translate-y-1"
              >
